...
public class UserDAO {
	...
	public void insert(User user) {
		...
		try {
			PreparedStatement p = con.prepareStatement("insert into users (name,country, email)   values (?, ? , ?)");
	...
	public ArrayList<User> selectAll(){
		...
		try {
			...
			while (r.next()) {
				...
				String pais = r.getString("country");
	...
	public void update(User updateUser) {
		...
		try {
			PreparedStatement p = con.prepareStatement("update users set name = ?, email = ?, country = ? where id = ?");
